...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "ACTIVE", "EXECUTED", "EXPIRED", "CANCELLED", name="signalstatus"),
            nullable=False,
        ),
        sa.Column(
            "outcome",
            sa.Enum("PENDING", "TP_HIT", "SL_HIT", "MANUAL_CLOSE", "EXPIRED", name="signaloutcome"),
            nullable=False,
        ),
        ...
        sa.Column(
            "suggested_position_size_percent", sa.Numeric(precision=5, scale=2), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "channel",
            sa.Enum("EMAIL", "TELEGRAM", "BOTH", name="notificationchannel"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_telegram_connections_id"), "telegram_connections", ["id"], unique=False
    )
    op.create_table(
        "wallets",
        sa.Column("id", sa.String(length=36), nullable=False),
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "ACTIVE", "DISCONNECTED", "SUSPENDED", name="walletstatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "PROCESSING", "COMPLETED", "FAILED", name="payoutstatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_affiliate_commissions_id"), "affiliate_commissions", ["id"], unique=False
    )
